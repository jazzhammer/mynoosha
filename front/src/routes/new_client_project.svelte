...
<div class="new-project flex flex-col border-myroon-100 border p-3 mr-6 ml-3 rounded w-full text-myhigh_white"
     style="min-width: 226px; max-width: 375px; font-size: 10pt;" data-testid="new_project"
>
  <div class="bg-mywood-900 rounded mb-5 w-full" data-testid="new_project_header" id="new_project_header">new project</div>
  <div class="client-form-fields text-mywood-900" data-testid="new_project_form">
<!--    <label class="field-label" data-testid="new_project_name">ymd issue-->
